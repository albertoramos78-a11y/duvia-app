...
export const RG_START = new Date("2026-05-24"); export const RG_END = new Date("2026-06-04T23:59:59");
export function isRGPeriod() { const n=new Date(); return n>=RG_START && n<=RG_END; }
...
export const WC_START = new Date("2026-06-06"); export const WC_END = new Date("2026-07-26T23:59:59");
export function isWCPeriod() { const n=new Date(); return n>=WC_START && n<=WC_END; }
...
// sombre (mêmes valeurs que DARK) et retombaient sous le seuil de contraste
// AA (4.5:1) en texte sur les fonds clairs de CE thème (card blanc, bulles à
// fond blanc translucide) — le plus visible sur les messages d'erreur de
// LoginScreen, qui rend toujours en BRAND quel que soit le thème du compte.
