...
const pt = {
    ...
    refPhaseTrialTitle:"🎁 Premium sem subscrição",refPhaseTrialBadge:"limite de {max} dias desde o dia 0",
    refTier1Label:"1º indicado validado",refTier2Label:"2º indicado validado",refTier3PlusLabel:"3º indicado e seguintes",
    refTier1Upgrade:"→ Premium – x dias 🎁",refTierCapReached:"Limite de 30 dias atingido",
    ...
    refStep3Title:"Ele valida as ações dele",refStep3Desc:"Assim que atinge {target} pts de envolvimento, passa para \"Premium – {days} dias restantes\" e tu recebes o teu bónus.",
