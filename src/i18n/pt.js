...
const pt = {
    ...
    emailOrPhoneHint:"💡 Sem email? Use um número de telefone.",
    ...
    contactsTitle:"Diretório",
    contactsSubtitle:"Números úteis partilhados com toda a família",
    contactsAdd:"+ Adicionar contacto",
    contactsAddTitle:"Novo contacto",
    contactsEditTitle:"Editar contacto",
    contactsEmpty:"Nenhum contacto guardado.",
    contactsName:"Nome / Função",
    contactsPhone:"Telefone",
    contactsNote:"Nota (opcional)",
    contactsReadOnly:"Visível para todos",
    contactsCall:"Ligar",
    contactsEdit:"Editar",
    contactsDelete:"Eliminar",
    contactsSave:"Guardar",
    contactsCancel:"Cancelar",
    contactsCatParents:"👨‍👩‍👧 Pais",
    contactsCatSchool:"🏫 Escola",
    contactsCatHealth:"🏥 Saúde",
    contactsCatObservers:"👁️ Observadores",
    contactsCatOther:"📋 Outros",
    contactsDefaultParent:"Pai/Mãe",
    contactsDefaultSchool:"Escola",
    contactsDefaultTeacher:"Diretor/a de turma",
    contactsDefaultDoctor:"Médico",
    contactsDefaultOther:"Outro contacto",
    scheduleTitle:"Horário de Aulas e Atividades",
    scheduleWeeklySubtitle:"Aulas, desporto, música... tudo num só lugar!",
    scheduleWeekView:"Vista semanal",
    scheduleChild:"Filho/a",
    scheduleNoChildren:"Configure primeiro os filhos em Configuração.",
    scheduleNoSlots:"Sem aulas nesse dia.",
    scheduleAddSlot:"+ Adicionar aula",
    scheduleAddTitle:"Nova aula",
    scheduleEditTitle:"Editar aula",
    scheduleDay:"Dia",
    scheduleSubject:"Disciplina",
    schedulePlaceholderSubject:"ex: Matemática, EF…",
    scheduleFrom:"Das",
    scheduleTo:"Às",
    scheduleRoom:"Sala",
    schedulePlaceholderRoom:"ex: 204",
    scheduleBuilding:"Edifício",
    scheduleTeacher:"Professor/a",
    scheduleErrSubject:"Disciplina obrigatória",
    scheduleSave:"Guardar",
    scheduleCancel:"Cancelar",
    scheduleEdit:"Editar",
    scheduleDelete:"Eliminar",
    scheduleSubjects:["Matemática","Português","História-Geografia","Ciências","Inglês","EF","Artes","Música","Tecnologia","Filosofia","Física-Química","Biologia","Francês","Alemão","Latim","Informática","Outra"],
    schoolHolsInfo:"Defina a guarda dia a dia.",
    vaultTitle:"Cofre",
    vaultViewFile:"Ver ficheiro",

    // ── Slide 3 : popups confirm() jusque-là hardcodées en français ──
    confirmLeaveFamilyFull:"Sair da família? Vai perder o acesso ao calendário e às mensagens.",
    confirmLeaveFamilySimple:"Sair da família?",
    confirmDeleteNotif:"Eliminar esta notificação?",
    confirmDeleteAllNotifs:"Eliminar todas as notificações ({n})?",
    confirmLeaveFamilyDetailed:"Sair desta família?\n\nVai recomeçar com uma família pessoal vazia. É guardado um resumo dos seus dados para exportação.",
    confirmRemoveGuest:"Remover {name} da família?\n\nEsta pessoa vai recomeçar com uma família pessoal vazia. Mantém a família e o respetivo código.",
    confirmCreateNewFamily:"Criar uma nova família separada? Vai poder alternar entre as suas famílias a partir do menu no topo da app.",
    confirmRejectRequest:"Recusar este pedido?",
    confirmRemoveChild:"Remover {name} da família?",
    confirmRemoveObserver:"Remover {name} da família?",
    ...
    deleteAccountDesc:"Esta ação é definitiva. Todos os seus dados serão eliminados.",
    expPaidBy:"Pago por",
    histSub:"Registo de alterações",
    msgAttach:"Anexar um ficheiro",
    msgCaptionPlaceholder:"Legenda (opcional)…",
    msgLoadingFile:"A carregar…",
    msgNotRegistered:"Ainda não registado — reenviar convite",
    msgNotRegisteredShort:"não registado",
    multiFamilyInfo:"Pertence a várias famílias. Use este menu para alternar entre elas.",
    multiFamilyTitle:"Várias famílias",
    ...
    clearAll:"Limpar",
    customDateLabel:"Data {n}",
    eventName:"Nome do evento",
    eventNamePlaceholder:"Ex: Esqui, Casamento...",
    dayLabel:"Dia",
    monthLabel:"Mês",
    yearLabel:"Ano",
    concernsLabel:"Refere-se a",
    childFallback:"Filho/a {id}",
    custodyAtLabel:"Guarda com",
    parentFallback:"Pai/Mãe {id}",
    yearlyRecurrence:"Repetir todos os anos",

    // ── Slide 7 : texte info dépenses ──
    expPendingInfo:"Toda a despesa adicionada fica ⏳ pendente até ser validada pelo outro progenitor. Depois de ✅ aceite, é contabilizada. Se for ❌ recusada, continua visível mas é excluída dos totais. Cada ação fica registada no histórico.",

    // ── Slide 9 : placeholders coffre-fort ──
    vaultNamePlaceholder:"ex: Sentença de 12/03/2023",
    vaultNotesPlaceholder:"ex: Assinado por ambas as partes...",
    ...
    years:"anos",
    joinedFamilyMsg:"juntou-se à família — mensagens ativadas",
    removedFromFamilyMsg:"foi removido da família.",
    overridesResetDetail:"Reinício das trocas manuais",
    overridesResetMsg:"Todas as trocas manuais foram reiniciadas",
    scheduleConfirmedFor:"Horário de {name} confirmado",
    expSeriesModified:"série modificada, requer nova validação",
    expModifiedRevalidate:"modificada — requer nova validação",
    occurrenceSingular:"ocorrência",
    occurrencesPlural:"ocorrências",
    expSeriesLabel:"Série",
    expSeriesDeleted:"Série eliminada",
    reimConfirmedMsg:"Reembolso de {name} ({amount}) confirmado",
    reimConfirmedTitle:"Reembolso confirmado",
    reimRejectedMsg:"Reembolso de {name} ({amount}) recusado",
    reimRejectedTitle:"Reembolso recusado",
    modifiedLabel:"Modificado",
    reimModifiedMsg:"Reembolso de {name} modificado ({amount}) — requer nova validação",
    vaultDocModifiedMsg:"Documento modificado: \"{name}\"",
    vaultDocModifiedTitle:"Documento modificado",
    vaultDocAddedMsg:"Documento adicionado: \"{name}\"",
    vaultDocAddedTitle:"Novo documento",
    vaultDocDeletedMsg:"Documento eliminado: \"{name}\"",
    vaultDocDeletedTitle:"Documento eliminado",

    // ── CGV ──
    viewCGV:"Ver Termos de Venda",
