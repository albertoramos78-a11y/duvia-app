...
const pt = {
    ...
    refFilleulPopupBody:"Completaste as ações necessárias e passas para Premium – {days} dias restantes! O teu indicador também recebe o bónus dele 💜",
    ...
    refStep3Title:"Ele valida as ações dele",refStep3Desc:"Assim que atinge {target} pts de envolvimento (ex: uma despesa adicionada, uma mensagem enviada, um contacto adicionado — 1 pt cada), passa para \"Premium – {days} dias restantes\" e tu recebes o teu bónus.",
