...
const fr = {
    ...
    refPhaseTrialTitle:"🎁 Phase Premium sans abonnement",refPhaseTrialBadge:"plafond {max}j depuis J0",
    refTier1Label:"1er filleul validé",refTier2Label:"2e filleul validé",refTier3PlusLabel:"3e filleul et +",
    refTier1Upgrade:"→ Premium – x j 🎁",refTierCapReached:"Plafond 30j atteint",
    ...
    refStep3Title:"Il valide ses actions",refStep3Desc:"Dès qu'il atteint {target} pts d'engagement, il passe en « Premium – {days}j restants » et vous recevez votre bonus.",
    ...
    refInviteModalDesc:"Partagez le lien + votre code — votre proche démarre en Trial Premium",
    ...
    refShareSmsBody:"Rejoins-moi sur Duvia 🏡 {link} — Code : {code}",
