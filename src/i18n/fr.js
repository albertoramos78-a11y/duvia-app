...
const fr = {
    ...
    refFilleulPopupBody:"Tu as complété les actions requises et passes en Premium – {days}j restants ! Ton parrain reçoit également son bonus 💜",
    ...
    refStep3Title:"Il valide ses actions",refStep3Desc:"Dès qu'il atteint {target} pts d'engagement (ex: dépense ajoutée, message envoyé, contact ajouté — 1 pt chacun), il passe en « Premium – {days}j restants » et vous recevez votre bonus.",
