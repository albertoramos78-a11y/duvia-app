...
const fr = {
    ...
    instagramLink:"Suivre Duvia sur Instagram",facebookLink:"Suivre Duvia sur Facebook",
    ...
    betaSignupPopupTitle:"Bêta — Trial Premium offert",
    betaSignupPopupDesc:"Duvia est actuellement en phase bêta : profite de toutes les fonctionnalités Premium gratuitement, sans carte bancaire, tant que dure la bêta.",
    betaSignupPopupBtn:"Compris",
    ...
    chatbotEmptyStateFaqOnly:"Pose-moi une question sur l'utilisation de Duvia (FAQ). L'assistant complet, qui connaît les données de ta famille, est réservé à Premium+IA.",
    ...
    chatbotFaqUpgradeBtn:"Pas la bonne réponse ? Passer à Premium+IA",
    chatbotAiUpsell:"Cette question dépasse la FAQ — l'assistant conversationnel complet est réservé à Premium+IA.",
    chatbotAiUpsellBtn:"Découvrir Premium+IA",
    chatbotGreetingHello:"Bonjour ! 👋 Pose-moi une question sur l'utilisation de Duvia.",
    chatbotGreetingBye:"À bientôt ! 👋",
    chatbotGreetingThanks:"Avec plaisir ! 😊",
    chatbotSendToSupportBtn:"Envoyer ma question à l'assistance",
    chatbotSupportSending:"Envoi…",
    chatbotSupportSent:"Merci ! Ta question a été transmise à l'équipe — elle nous aide à améliorer Duvia.",
    chatbotSupportSendError:"⚠️ Échec de l'envoi à l'assistance. Réessaie.",
    ...
    calExportPdfModalTitle:"Export PDF",
    calExportPdfModalSub:"Planning sur 12 mois glissants",
    calExportPdfStartLabel:"À partir de quel mois ?",
    calExportPdfGenerate:"Générer le PDF",
    ...
    expDeletePendingLabel:"⏳ Suppression en attente de validation",
    ...
    wheelPrizeTableSubscriberTitle:"Réservé aux abonnés Premium",
    ...
    regPwRuleLength:"Au moins 8 caractères",
    regPwRuleUpper:"Une majuscule",
    regPwRuleSpecial:"Un caractère spécial (ex : ! ? @ #)",
    regPhone:"📞 Téléphone",
    ...
    pensionEndBtn: "Mettre fin à la pension",
    pensionCancelEndBtn: "Annuler la demande",
    pensionEndRequestedBy: "souhaite mettre fin à cette pension.",
    pensionConfirmEndBtn: "Confirmer la fin",
    pensionEndPendingLabel: "⏳ Fin en attente de validation",
    ...
    menuFaq:"Aide / FAQ",
    faqTitle:"Aide / FAQ",
    faqSearchPlaceholder:"Rechercher dans l'aide…",
    faqNoResults:"Aucun résultat pour cette recherche.",
