...
const en = {
    ...
    emailOrPhonePlaceholder:"email@example.com or +1 234 567 8900",
    emailOrPhoneHint:"💡 No email? Use a phone number instead.",
    ...
    contactsSubtitle:"Useful numbers shared with the whole family",
    contactsAdd:"+ Add a contact",
    contactsAddTitle:"New contact",
    contactsEditTitle:"Edit contact",
    contactsEmpty:"No contacts saved.",
    contactsName:"Name / Role",
    contactsPhone:"Phone",
    contactsNote:"Note (optional)",
    contactsReadOnly:"Visible to everyone",
    contactsCall:"Call",
    contactsEdit:"Edit",
    ...
    contactsCatSchool:"🏫 School",
    contactsCatHealth:"🏥 Health",
    contactsCatObservers:"👁️ Observers",
    contactsCatOther:"📋 Other",
    contactsDefaultParent:"Parent",
    contactsDefaultSchool:"School",
    contactsDefaultTeacher:"Homeroom teacher",
    contactsDefaultDoctor:"Doctor",
    contactsDefaultOther:"Other contact",
    scheduleTitle:"Class & Activities Schedule",
    scheduleWeeklySubtitle:"Classes, sports, music... all in one place!",
    scheduleWeekView:"Week view",
    scheduleChild:"Child",
    scheduleNoChildren:"Set up children in Settings first.",
    scheduleNoSlots:"No classes that day.",
    scheduleAddSlot:"+ Add a class",
    scheduleAddTitle:"New class",
    scheduleEditTitle:"Edit class",
    scheduleDay:"Day",
    scheduleSubject:"Subject",
    schedulePlaceholderSubject:"e.g. Mathematics, PE…",
    scheduleFrom:"From",
    scheduleTo:"To",
    scheduleRoom:"Room",
    schedulePlaceholderRoom:"e.g. 204",
    scheduleBuilding:"Building",
    scheduleTeacher:"Teacher",
    scheduleErrSubject:"Subject is required",
    scheduleSave:"Save",
    scheduleCancel:"Cancel",
    scheduleEdit:"Edit",
    scheduleDelete:"Delete",
    scheduleSubjects:["Mathematics","English","History-Geography","Science","Spanish","PE","Art","Music","Technology","Philosophy","Physics-Chemistry","Biology","French","German","Latin","Computer Science","Other"],
    vaultTitle:"Vault",

    // ── Slide 3 : popups confirm() jusque-là hardcodées en français ──
    confirmLeaveFamilyFull:"Leave the family? You'll lose access to the calendar and messages.",
    confirmLeaveFamilySimple:"Leave the family?",
    confirmDeleteNotif:"Delete this notification?",
    confirmDeleteAllNotifs:"Delete all notifications ({n})?",
    confirmLeaveFamilyDetailed:"Leave this family?\n\nYou'll start over with a blank personal family. A summary of your data is kept for export.",
    confirmRemoveGuest:"Remove {name} from the family?\n\nThey'll start over with a blank personal family. You keep the family and its code.",
    confirmCreateNewFamily:"Create a separate new family? You'll be able to switch between your families from the menu at the top of the app.",
    confirmRejectRequest:"Reject this request?",
    confirmRemoveChild:"Remove {name} from the family?",
    confirmRemoveObserver:"Remove {name} from the family?",

    // ── Slide 4 : 14 clés trouvées par audit complet (utilisées dans App.jsx mais jamais définies) ──
    deleteAccount:"Delete my account",
    deleteAccountDesc:"This action is permanent. All your data will be deleted.",
    expPaidBy:"Paid by",
    histSub:"Change log",
    msgAttach:"Attach a file",
    msgCaptionPlaceholder:"Caption (optional)…",
    msgLoadingFile:"Loading…",
    msgNotRegistered:"Not registered yet — resend invitation",
    msgNotRegisteredShort:"not registered",
    multiFamilyInfo:"You belong to several families. Use this menu to switch between them.",
    multiFamilyTitle:"Multiple families",
    ...
    eventNamePlaceholder:"E.g.: Ski trip, Wedding...",
    dayLabel:"Day",
    monthLabel:"Month",
    yearLabel:"Year",
    concernsLabel:"Concerns",
    childFallback:"Child {id}",
    custodyAtLabel:"Custody with",
    parentFallback:"Parent {id}",
    yearlyRecurrence:"Repeat every year",

    // ── Slide 7 : texte info dépenses ──
    expPendingInfo:"Every expense added is ⏳ pending until approved by the other parent. Once ✅ accepted, it's included in the totals. If ❌ rejected, it stays visible but is excluded from totals. Every action is logged in the history.",

    // ── Slide 9 : placeholders coffre-fort ──
    vaultNamePlaceholder:"e.g.: Court ruling 12/03/2023",
    vaultNotesPlaceholder:"e.g.: Signed by both parties...",
    ...
    years:"years old",
    joinedFamilyMsg:"joined the family — messaging enabled",
    removedFromFamilyMsg:"was removed from the family.",
    overridesResetDetail:"Manual exchanges reset",
    overridesResetMsg:"All manual exchanges have been reset",
    scheduleConfirmedFor:"{name}'s schedule confirmed",
    expSeriesModified:"series modified, re-approval needed",
    expModifiedRevalidate:"modified — re-approval needed",
    occurrenceSingular:"occurrence",
    occurrencesPlural:"occurrences",
    expSeriesLabel:"Series",
    expSeriesDeleted:"Series deleted",
    reimConfirmedMsg:"Reimbursement from {name} ({amount}) confirmed",
    reimConfirmedTitle:"Reimbursement confirmed",
    reimRejectedMsg:"Reimbursement from {name} ({amount}) rejected",
    reimRejectedTitle:"Reimbursement rejected",
    modifiedLabel:"Modified",
    reimModifiedMsg:"Reimbursement from {name} modified ({amount}) — re-approval needed",
    vaultDocModifiedMsg:"Document modified: \"{name}\"",
    vaultDocModifiedTitle:"Document modified",
    vaultDocAddedMsg:"Document added: \"{name}\"",
    vaultDocAddedTitle:"New document",
    vaultDocDeletedMsg:"Document deleted: \"{name}\"",
    vaultDocDeletedTitle:"Document deleted",

    // ── CGV ──
    viewCGV:"View Terms of Sale",
