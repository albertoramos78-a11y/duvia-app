...
const en = {
    ...
    refEarnedBadge:"Premium – {days}d left 🎁",refTrialBadge:"Trial Premium – {days}d left",
    refFelicitations:"Congratulations!",
    refFilleulPopupBody:"You've completed the required actions and switched to Premium – {days} days left! You've also unlocked the exclusive \"Sprout\" theme 🌱. Your referrer also gets their bonus 💜",
    refFilleulPopupBtn:"Awesome, thanks! 🙌",
    refBonneNouvelle:"Good news!",
    refReferrerPopupBody:"The person you referred has validated their account. Your bonus days + 🎰 spin token have been credited!",
    refReferrerPopupBtn:"Great! 🙌",
    refPlafond:"Cap",refDepuisJ0:"since day 0",
    refCopyBtn:"📋 Copy",
    refDemoModeLabel:"🧪 Demo mode (admin)",
    refSimulateBtn:"Simulate a validated referee",
    refStatInvited:"Invited",refStatValidated:"Validated",refStatDaysEarned:"Days earned",refStatSpins:"Spin tokens",
    refFilleulProgressTitle:"Your progress (as a referee)",refPtsUnit:"pts",
    refFilleulProgressDesc:"Reach {target} pts ({strong} strong actions) to unlock: Premium – {days} days for you + a bonus for your referrer",
    refEngagementPointsExplain:"💸 An expense added, 💬 a message sent, or 👤 a contact added each counts for 1 point.",
    refFilleulValidatedMsg:"Referee validated — welcome to the Duvia family! 💜",
    refRewardsTitle:"Your referrer rewards",
    refPhaseFreemiumTitle:"🎁 Freemium or inherited Premium phase",refFreemiumTierLabel:"Each referee",
    refPhaseTrialTitle:"🎁 Trial Premium phase (15d)",refPhaseTrialBadge:"capped at {max}d since day 0",
    refPhaseTrialSubtitle:"Gets up to 1 month of free Trial Premium use",
    refTier1Label:"1st validated referee",refTier2Label:"2nd validated referee",refTier3PlusLabel:"3rd referee and beyond",
    refTierCapReached:"30-day cap reached",
    ...
    refStep3Title:"They validate their actions",refStep3Desc:"Once they reach {target} engagement pts (various actions in the app), they unlock the exclusive \"Sprout\" theme 🌱 and you get your bonus.",
    refStep4Title:"They can refer others too",refStep4Desc:"A validated referee can invite others in turn. The same rules apply.",
    refInviteModalDesc:"Share this link — your friend starts on Trial Premium",
    refInviteLinkLabel:"Invite link",refCodeColonLabel:"Code:",
    refCopyLinkBtn:"Copy link",refByEmail:"By email",refBySms:"By text",refCloseBtn:"Close",
    refDemoValidatingTitle:"Validating…",refDemoValidatingDesc:"A referee reached the required score",
    refDemoValidatedTitle:"Referee validated!",refDemoBonusCredited:"+{n}d credited to your account",
    refDemoCapReachedNote:"Cap reached — spin awarded anyway!",refDemoSpinAwarded:"🎰 +{n} spin token",
    refOkBtn:"OK",
    refShareEmailSubject:"Join me on Duvia 🏡",
    refShareEmailBody:"Hi!\n\nI'm inviting you to Duvia, the app that makes co-parenting simpler.\n\nDownload the app and create your account via this link: {link}\n\nSee you on Duvia!",
    ...
    refShareSmsBody:"Join me on Duvia 🏡 {link}",
    ...
    betaSignupPopupTitle:"Beta — Free Trial Premium",
    betaSignupPopupDesc:"Duvia is currently in beta: enjoy all Premium features for free, no credit card, for as long as the beta lasts.",
    betaSignupPopupBtn:"Got it",
    ...
    premBetaFooter1:"A paid subscription will be offered once the beta ends.",
    premBetaFooter2:"You'll be notified in advance, no date has been set yet.",
    premAdminLabel:"Admin ⚙️",premActiveLabel:"Premium Active ⭐",
    premEarnedLabel:"Premium – {days}d left 🎁",
    premTrialLabel:"Trial Premium — {days} day{s} left",
    premFreemiumLabel:"Freemium",
    premFamilyBanner:"👨‍👩‍👧 Premium via your family",
    premFamilyBannerSuffix:" : {email} subscribed",
    premTrialUpgradeHint:"Upgrade to Premium for unlimited access",
    premFreemiumHint:"Permanent free account — limited features",
    premYearlyBadge:"2 months free",premAvailableAfterBeta:"🔒 Available after the beta",premChooseBtn:"Choose",
    premFeaturesTitle:"Included features",premComingSoon:"Coming soon",premUnlimited:"Unlimited",
    premFeatParents:"Parents",premFeatChildren:"Children",premFeatObservers:"Observers",
    premFeatCalendar:"Custody calendar",premFeatHolidays:"Public holidays, 15+ countries",
    premFeatWeather:"Weather on the calendar",premFeatMotherFatherDay:"Mother's / Father's Day",
    premFeatBirthdays:"Parents' & children's birthdays",premFeatCustomDates:"Custom dates",
    premFeatSchedule:"Children's schedule",premFeatExpenses:"Expenses & reimbursements",
    premFeatExpenseBalance:"Expenses: Balance visible",
    premFeatContactsView:"Directory (no adding numbers)",
    premFeatContactsAdd:"Contact directory: add numbers",
    premFeatVault:"Vault",premFeatMessaging:"Family messaging",
    premFeatWheel:"Duvia Wheel — game & rewards",
    premFeatLanguages:"5 languages (FR · EN · DE · ES · PT)",premFeatPWA:"Installable on mobile (PWA)",
    premFeatExportExpenses:"Expense PDF export",premFeatExportCalendar:"Yearly calendar PDF export",
    ...
    chatbotEmptyStateFaqOnly:"Ask me a question about using Duvia (FAQ). The full assistant, which knows your family's data, is a Premium+AI feature.",
    ...
    chatbotFaqInstantLabel:"Instant answer (FAQ)",
    chatbotFaqNotHelpfulBtn:"Not the right answer?",
    chatbotFaqUpgradeBtn:"Not the right answer? Upgrade to Premium+AI",
    chatbotAiUpsell:"This question goes beyond the FAQ — the full conversational assistant is a Premium+AI feature.",
    chatbotAiUpsellBtn:"Discover Premium+AI",
    chatbotGreetingHello:"Hello! 👋 Ask me a question about using Duvia.",
    chatbotGreetingBye:"See you soon! 👋",
    chatbotGreetingThanks:"You're welcome! 😊",
    chatbotSendToSupportBtn:"Send my question to support",
    chatbotSupportSending:"Sending…",
    chatbotSupportSent:"Thank you! Your question was sent to the team — it helps us improve Duvia.",
    chatbotSupportSendError:"⚠️ Failed to send to support. Try again.",
    chatbotDoubleTapHint:"Double-tap anywhere on the screen to hide/show the assistant.",
    ...
    calResetTitle:"🔄 Reset manual exchanges?",
    calResetBodyOne:"1 manual exchange on the calendar will be deleted. The schedule will revert to the base rule (week A/B, exclusive custody…). This action is irreversible.",
    calResetBodyOther:"{n} manual exchanges on the calendar will be deleted. The schedule will revert to the base rule (week A/B, exclusive custody…). This action is irreversible.",
    calResetConfirm:"Reset",
    calResetHistLabel:"Manual exchanges reset",
    calResetNotif:"📅 All manual exchanges have been reset",
    calExportICalTitle:"Export to Google Calendar / Apple Calendar",
    calExportPDFTitle:"Export the yearly schedule to PDF",
    calExportPdfModalTitle:"PDF export",
    calExportPdfModalSub:"12-month rolling schedule",
    calExportPdfStartLabel:"Starting from which month?",
    calExportPdfGenerate:"Generate PDF",
    ...
    expDeletePendingLabel:"⏳ Deletion awaiting approval",
    ...
    wheelPrizeTableSubscriberTitle:"Reserved for Premium subscribers",
    ...
    wheelFilleulActiveInfo:"Theme active · Disable via the ☰ menu or 🏆",
    ...
    regPwRuleLength:"At least 8 characters",
    regPwRuleUpper:"One uppercase letter",
    regPwRuleSpecial:"One special character (e.g. ! ? @ #)",
    regPhone:"📞 Phone",
    ...
    expTipBody:"Track and share your child's expenses, and manage child support. This section is visible to parents only.",
    ...
    rgpdTitle:"🔒 Your data and your privacy",
    rgpdIntro:"Duvia processes personal data (identity, custody schedules, expenses, documents, messages) to help you organize your children's lives. Your data is stored securely and is never sold.",
    rgpdRights:"You have the right to access, rectify, erase and port your data, as well as the right to lodge a complaint with the relevant data protection authority. You can delete your account and your data at any time from the settings.",
    rgpdSeeMore:"Learn more:",
    ...
    inviteGenerate:"🔗 Generate invitation link",
    inviteGenerating:"⏳ Generating…",
    linkReady:"Link ready!",
    chooseHowSend:"Choose how to send it (valid for 24h):",
    ...
    pensionEndBtn: "End the pension",
    pensionCancelEndBtn: "Cancel the request",
    pensionEndRequestedBy: "wants to end this pension.",
    pensionConfirmEndBtn: "Confirm the end",
    pensionEndPendingLabel: "⏳ End awaiting validation",
    ...
    menuFaq:"Help / FAQ",
    faqTitle:"Help / FAQ",
    faqSearchPlaceholder:"Search help…",
    faqNoResults:"No results for this search.",
    ...
    backupImportOk:"Backup imported successfully.",
    backupImportFailed:"Could not import the file.",
    backupExportFailed:"Export failed. Please try again.",
    backupReplaceConfirm:"This will REPLACE your family setup, custody calendar and school calendar.\n\nAn automatic backup of your current data will be downloaded first.\n\nContinue?",
    backupOtherFamilyConfirm:"⚠️ This file belongs to ANOTHER family.\n\nContinue? Your current data will be overwritten.",
    backupErrNoFile:"No file.",
    backupErrTooLarge:"File too large (>25 MB).",
    backupErrInvalidJson:"Unreadable file (invalid JSON).",
    ...
    subManage:"Manage my subscription",
    subCancel:"Cancel my subscription",
    subCancelDesc:"You can cancel at any time. Your subscription stays active until the end of the paid period, then you'll switch back to Freemium automatically. Your data is kept.",
    subCancelConfirmTitle:"Cancel subscription?",
    subCancelConfirmDesc:"Your subscription will remain active until {date}. You'll then switch back to Freemium. Your data will be kept.",
    subCancelYes:"Confirm",
    no:"No",
    subCancelledTitle:"Cancellation scheduled",
    subCancelledDesc:"Your subscription remains active until {date}, then you'll switch back to Freemium.",
    subResume:"Resume my subscription",
    myDuviaId:"My Duvia ID",
    myDuviaIdHint:"Share this with Duvia support if you need help.",
    copy:"Copy",
    copied:"Copied",
    clearLocalData:"Delete local backup",
    clearLocalDataHint:"Clears the copy stored on this device (data stays on the server).",
    localDataCleared:"Local data deleted",
    emailOrPhone:"Email or phone",
    emailOrPhonePlaceholder:"email@example.com or +44 7700 900000",
    ...
    clear:"Clear",
    cdEventName:"Event name",
    cdEventPh:"E.g. Ski trip, Wedding…",
    cdDay:"Day",
    cdMonth:"Month",
    cdYear:"Year",
    cdDate:"Date",
    ...
    childN:"Child",
    parentN:"Parent",
    expRecurring:"Recurring expense",
    ...
    googleAccountDesc:"Your email and password are managed by Google. Change them at",
    changePw:"Change my password",
    pwCurrent:"Current password",
    pwNew:"New password (8 chars · uppercase · special)",
    ...
    vaultStorageUsed:"Storage used",
    vaultEmptyHint:"Tap + to add your first document",
    childHealth:"🩺 Health",
    childAllergy:"Allergies",
    childAllergyPh:"e.g. peanuts, latex…",
    childBloodType:"Blood type",
    childAtHome:"At {parent}'s",
    childSchool:"🏫 School / Class",
    childSchoolPh:"e.g. Maple School, Year 4",
    childDoctor:"👨‍⚕️ Doctor / Pediatrician",
    childDoctorPh:"Name, practice, phone",
    childNotes:"📝 Notes",
    childNotesPh:"Activities, routines, useful info…",
    childEmergency:"🚨 Emergency contacts",
    childEmergencyPh:"Name, relationship, phone",
    childReadOnly:"(managed by {parent})",
    childInfoCardTitle:"🧒 Child info",
    childInfoCardEmpty:"No child registered yet.",
    childInviteTitle:"📨 Invite {name} to join the app",
    childInviteGenerate:"🔗 Generate link for {name}",
    childInviteGenerating:"⏳ Generating…",
    childInviteValid:"Link valid for 30 days.",
    childInviteMsg:"🧒 Join the family as a child",
    childInvErrExpired:"⚠️ This child link has expired (30 days). Ask your parents for a new one.",
    ...
    optional:"optional",
    obsRemoveGuest:"Remove guest",
    obsRelationship:"Relationship with child",
    obsRelationshipPh:"e.g. Léa's grandfather, Tom's nanny, Trusted neighbour…",
    obsNotes:"📋 Observation",
    obsNotesPh:"Useful info, habits, specific details to note…",
    ...
    obsPrefsMenu:"Preferences",
    obsPrefsIntro:"As an observer, you can only edit your own profile: language, notifications, ID, email/password and account.",
    obsNotifMsgDesc:"Email when you receive a new message",
    obsBackupBeforeDeleteHint:"Only your identity details (name, email, phone) will be downloaded — not the family's data.",
    childPrefsIntro:"As a child, you can only edit your own profile: language, notifications, ID and account.",
    obsBackupExportBtn:"Download my identity card",
    obsBackupExportHint:"Only your details (name, email, phone) are downloaded — not the family's data.",
    ...
    obsNoFamily:"You are not assigned to a family.",
    obsNoFamilyDesc:"Only a family can invite you to join Duvia. Contact the parent who wanted to give you access so they can generate a new invitation link.",
    obsLeaveFamilyConfirm:"Leave the family? You will no longer have access to the calendar or messaging.",
    leaveFamilyConfirmSimple:"Leave the family?",
    deleteNotifConfirm:"Delete this notification?",
    deleteAllNotifsConfirm:"Delete all notifications ({count})?",
    quitterFamilleConfirm:"Leave this family?\n\nYou will start over with a blank personal family. A summary of your data is kept for export.",
    retirerInviteConfirm:"Remove {name} from the family?\n\nThey will start over with a blank personal family. You keep the family and its code.",
    createNewFamilyConfirm:"Create a new, separate family? You'll be able to switch between your families from the menu at the top of the app.",
    createNewFamilyBtn:"Create Family",
    creatingFamilyLabel:"⏳ Creating…",
    cdDefaultCalendar:"📅 Default calendar",
