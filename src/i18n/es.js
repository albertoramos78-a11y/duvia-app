...
const es = {
    ...
    instagramLink:"Seguir a Duvia en Instagram",facebookLink:"Seguir a Duvia en Facebook",
    ...
    refFilleulPopupBody:"Has completado las acciones requeridas y pasas a Premium – ¡{days} días restantes! También desbloqueas el tema exclusivo \"Brote\" 🌱. Tu referidor también recibe su bono 💜",
    ...
    refEngagementPointsExplain:"💸 Un gasto añadido, 💬 un mensaje enviado o 👤 un contacto añadido cuenta 1 punto cada uno.",
    refFilleulValidatedMsg:"Referido validado — ¡bienvenido a la familia Duvia! 💜",
    refRewardsTitle:"Tus recompensas de referidor",
    refPhaseFreemiumTitle:"🎁 Fase Freemium o Premium heredado",refFreemiumTierLabel:"Cada referido",
    refPhaseTrialTitle:"🎁 Fase Trial Premium (15 días)",refPhaseTrialSubtitle:"Obtiene hasta 1 mes de uso gratuito de Trial Premium",refPhaseTrialBadge:"límite de {max} días desde el día 0",
    refTier1Label:"1er referido validado",refTier2Label:"2º referido validado",refTier3PlusLabel:"3er referido y siguientes",
    refTierCapReached:"Límite de 30 días alcanzado",
    ...
    refStep3Title:"Valida sus acciones",refStep3Desc:"En cuanto alcanza {target} pts de interacción (acciones diversas en la aplicación), desbloquea el tema exclusivo \"Brote\" 🌱 y tú recibes tu bono.",
    ...
    pendingFamilyNoticeMsg:"Tu solicitud para unirte a la nueva familia ha sido enviada — aparecerá en tu selector de familias una vez aprobada.",
    ...
    calExportPdfModalTitle:"Exportar PDF",
    calExportPdfModalSub:"Calendario de 12 meses móviles",
    calExportPdfStartLabel:"¿A partir de qué mes?",
    calExportPdfGenerate:"Generar PDF",
    calResetBtnTitle:"Reiniciar todos los intercambios manuales del calendario",
    calResetBtnLabel:"Reiniciar",
    calActionsMenuTitle:"Opciones del calendario",
    ...
    expDeletePendingLabel:"⏳ Eliminación pendiente de validación",
    ...
    wheelPrizeTableSubscriberTitle:"Reservado para suscriptores Premium",
    ...
    wheelFilleulActiveInfo:"Tema activo · Desactívalo desde el menú ☰ o 🏆",
    ...
    regGenderOther:"🧑 Otro",
    regPwRuleLength:"Al menos 8 caracteres",
    regPwRuleUpper:"Una mayúscula",
    regPwRuleSpecial:"Un carácter especial (ej. ! ? @ #)",
    regPhone:"📞 Teléfono",
    ...
    betaSignupPopupTitle:"Beta — Trial Premium gratis",
    betaSignupPopupDesc:"Duvia está actualmente en fase beta: disfruta de todas las funciones Premium gratis, sin tarjeta bancaria, mientras dure la beta.",
    betaSignupPopupBtn:"Entendido",
    confirmPw:"Confirmación",
    ...
    rgpdDeclineLogout:"Cerrar sesión",
    ...
    pensionConfirmReceiptBtn: "He recibido el pago",
    pensionCancelBtn: "Cancelar",
    pensionRefuseBtn: "Rechazar",
    ...
    pensionEditAmountBtn: "Modificar el importe",
    pensionEndBtn: "Poner fin a la pensión",
    pensionCancelEndBtn: "Cancelar la solicitud",
    pensionEndRequestedBy: "quiere poner fin a esta pensión.",
    pensionConfirmEndBtn: "Confirmar el fin",
    pensionEndPendingLabel: "⏳ Fin pendiente de validación",
    ...
    menuFaq:"Ayuda / FAQ",
    faqTitle:"Ayuda / FAQ",
    faqSearchPlaceholder:"Buscar en la ayuda…",
    faqNoResults:"Sin resultados para esta búsqueda.",
  ...
  // --- i18n additions ---
    ...
    chatbotGreetingHello:"¡Hola! 👋 Hazme una pregunta sobre el uso de Duvia.",
    chatbotGreetingBye:"¡Hasta pronto! 👋",
    chatbotGreetingThanks:"¡Con gusto! 😊",
