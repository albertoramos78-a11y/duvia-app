...
const es = {
    ...
    emailOrPhonePlaceholder:"email@ejemplo.es o 612 345 678",
    ...
    contactsTitle:"Directorio",
    contactsSubtitle:"Números útiles compartidos con toda la familia",
    contactsAdd:"+ Añadir contacto",
    contactsAddTitle:"Nuevo contacto",
    contactsEditTitle:"Editar contacto",
    contactsEmpty:"No hay contactos guardados.",
    contactsName:"Nombre / Rol",
    contactsPhone:"Teléfono",
    contactsNote:"Nota (opcional)",
    contactsReadOnly:"Visible para todos",
    contactsCall:"Llamar",
    contactsEdit:"Editar",
    contactsDelete:"Eliminar",
    contactsSave:"Guardar",
    contactsCancel:"Cancelar",
    contactsCatParents:"👨‍👩‍👧 Padres",
    contactsCatSchool:"🏫 Colegio",
    contactsCatHealth:"🏥 Salud",
    contactsCatObservers:"👁️ Observadores",
    contactsCatOther:"📋 Otros",
    contactsDefaultParent:"Padre/Madre",
    contactsDefaultSchool:"Colegio",
    contactsDefaultTeacher:"Tutor/a",
    contactsDefaultDoctor:"Médico",
    contactsDefaultOther:"Otro contacto",
    scheduleTitle:"Horario de Clases y Actividades",
    scheduleWeeklySubtitle:"Clases, deporte, música... ¡todo en un solo lugar!",
    scheduleWeekView:"Vista semanal",
    scheduleChild:"Hijo/a",
    scheduleNoChildren:"Configura primero los hijos en Configuración.",
    scheduleNoSlots:"Sin clases ese día.",
    scheduleAddSlot:"+ Añadir clase",
    scheduleAddTitle:"Nueva clase",
    scheduleEditTitle:"Editar clase",
    scheduleDay:"Día",
    scheduleSubject:"Asignatura",
    schedulePlaceholderSubject:"ej: Matemáticas, EF…",
    scheduleFrom:"De",
    scheduleTo:"A",
    scheduleRoom:"Aula",
    schedulePlaceholderRoom:"ej: 204",
    scheduleBuilding:"Edificio",
    scheduleTeacher:"Profesor/a",
    scheduleErrSubject:"La asignatura es obligatoria",
    scheduleSave:"Guardar",
    scheduleCancel:"Cancelar",
    scheduleEdit:"Editar",
    scheduleDelete:"Eliminar",
    scheduleSubjects:["Matemáticas","Lengua","Historia-Geografía","Ciencias","Inglés","EF","Plástica","Música","Tecnología","Filosofía","Física-Química","Biología","Francés","Alemán","Latín","Informática","Otra"],
    schoolHolsInfo:"Define la custodia día a día.",
    vaultTitle:"Caja fuerte",
    vaultViewFile:"Ver archivo",

    // ── Slide 3 : popups confirm() jusque-là hardcodées en français ──
    confirmLeaveFamilyFull:"¿Salir de la familia? Perderás el acceso al calendario y a los mensajes.",
    confirmLeaveFamilySimple:"¿Salir de la familia?",
    confirmDeleteNotif:"¿Eliminar esta notificación?",
    confirmDeleteAllNotifs:"¿Eliminar todas las notificaciones ({n})?",
    confirmLeaveFamilyDetailed:"¿Salir de esta familia?\n\nEmpezarás de nuevo con una familia personal vacía. Se conserva un resumen de tus datos para exportar.",
    confirmRemoveGuest:"¿Eliminar a {name} de la familia?\n\nEsta persona empezará de nuevo con una familia personal vacía. Conservas la familia y su código.",
    confirmCreateNewFamily:"¿Crear una nueva familia independiente? Podrás cambiar entre tus familias desde el menú en la parte superior de la app.",
    confirmRejectRequest:"¿Rechazar esta solicitud?",
    confirmRemoveChild:"¿Eliminar a {name} de la familia?",
    confirmRemoveObserver:"¿Eliminar a {name} de la familia?",

    // ── Slide 4 : 14 clés trouvées par audit complet (utilisées dans App.jsx mais jamais définies) ──
    deleteAccount:"Eliminar mi cuenta",
    deleteAccountDesc:"Esta acción es definitiva. Se eliminarán todos tus datos.",
    expPaidBy:"Pagado por",
    histSub:"Registro de cambios",
    msgAttach:"Adjuntar un archivo",
    msgCaptionPlaceholder:"Descripción (opcional)…",
    msgLoadingFile:"Cargando…",
    msgNotRegistered:"Aún no registrado — reenviar invitación",
    msgNotRegisteredShort:"no registrado",
    multiFamilyInfo:"Perteneces a varias familias. Usa este menú para cambiar entre ellas.",
    multiFamilyTitle:"Varias familias",
    ...
    clearAll:"Borrar",
    customDateLabel:"Fecha {n}",
    eventName:"Nombre del evento",
    eventNamePlaceholder:"Ej: Esquí, Boda...",
    dayLabel:"Día",
    monthLabel:"Mes",
    yearLabel:"Año",
    concernsLabel:"Concierne a",
    childFallback:"Hijo/a {id}",
    custodyAtLabel:"Custodia con",
    parentFallback:"Padre/Madre {id}",
    yearlyRecurrence:"Repetir cada año",

    // ── Slide 7 : texte info dépenses ──
    expPendingInfo:"Todo gasto añadido queda ⏳ pendiente hasta que el otro progenitor lo valide. Una vez ✅ aceptado, se contabiliza. Si se ❌ rechaza, sigue visible pero se excluye de los totales. Cada acción queda registrada en el historial.",

    // ── Slide 9 : placeholders coffre-fort ──
    vaultNamePlaceholder:"ej: Sentencia del 12/03/2023",
    vaultNotesPlaceholder:"ej: Firmado por ambas partes...",
    ...
    years:"años",
    joinedFamilyMsg:"se ha unido a la familia — mensajería activada",
    removedFromFamilyMsg:"ha sido eliminado de la familia.",
    overridesResetDetail:"Reinicio de los intercambios manuales",
    overridesResetMsg:"Se han reiniciado todos los intercambios manuales",
    scheduleConfirmedFor:"Calendario de {name} confirmado",
    expSeriesModified:"serie modificada, requiere nueva validación",
    expModifiedRevalidate:"modificada — requiere nueva validación",
    occurrenceSingular:"repetición",
    occurrencesPlural:"repeticiones",
    expSeriesLabel:"Serie",
    expSeriesDeleted:"Serie eliminada",
    reimConfirmedMsg:"Reembolso de {name} ({amount}) confirmado",
    reimConfirmedTitle:"Reembolso confirmado",
    reimRejectedMsg:"Reembolso de {name} ({amount}) rechazado",
    reimRejectedTitle:"Reembolso rechazado",
    modifiedLabel:"Modificado",
    reimModifiedMsg:"Reembolso de {name} modificado ({amount}) — requiere nueva validación",
    vaultDocModifiedMsg:"Documento modificado: \"{name}\"",
    vaultDocModifiedTitle:"Documento modificado",
    vaultDocAddedMsg:"Documento añadido: \"{name}\"",
    vaultDocAddedTitle:"Nuevo documento",
    vaultDocDeletedMsg:"Documento eliminado: \"{name}\"",
    vaultDocDeletedTitle:"Documento eliminado",

    // ── CGV ──
    viewCGV:"Ver Condiciones de Venta",
