...
const de = {
    ...
    emailOrPhonePlaceholder:"email@beispiel.de oder 0151 23456789",
    emailOrPhoneHint:"💡 Keine E-Mail? Nutzen Sie eine Telefonnummer.",
    ...
    // ── Ajout audit traduction (Répertoire, Emploi du temps, Coffre) ──
    contactsTitle:"Verzeichnis",
    contactsSubtitle:"Nützliche Nummern, geteilt mit der ganzen Familie",
    contactsAdd:"+ Kontakt hinzufügen",
    contactsAddTitle:"Neuer Kontakt",
    contactsEditTitle:"Kontakt bearbeiten",
    contactsEmpty:"Keine Kontakte gespeichert.",
    contactsName:"Name / Rolle",
    contactsPhone:"Telefon",
    contactsNote:"Notiz (optional)",
    contactsReadOnly:"Für alle sichtbar",
    contactsCall:"Anrufen",
    contactsEdit:"Bearbeiten",
    contactsDelete:"Löschen",
    contactsSave:"Speichern",
    contactsCancel:"Abbrechen",
    contactsCatParents:"👨‍👩‍👧 Eltern",
    contactsCatSchool:"🏫 Schule",
    contactsCatHealth:"🏥 Gesundheit",
    contactsCatObservers:"👁️ Beobachter",
    contactsCatOther:"📋 Sonstige",
    contactsDefaultParent:"Elternteil",
    contactsDefaultSchool:"Schule",
    contactsDefaultTeacher:"Klassenlehrer",
    contactsDefaultDoctor:"Arzt",
    contactsDefaultOther:"Sonstiger Kontakt",
    scheduleTitle:"Stunden- und Freizeitplan",
    scheduleWeeklySubtitle:"Unterricht, Sport, Musik... alles an einem Ort!",
    scheduleWeekView:"Wochenansicht",
    scheduleChild:"Kind",
    scheduleNoChildren:"Richten Sie zuerst die Kinder in den Einstellungen ein.",
    scheduleNoSlots:"Kein Unterricht an diesem Tag.",
    scheduleAddSlot:"+ Unterricht hinzufügen",
    scheduleAddTitle:"Neuer Unterricht",
    scheduleEditTitle:"Unterricht bearbeiten",
    scheduleDay:"Tag",
    scheduleSubject:"Fach",
    schedulePlaceholderSubject:"z. B. Mathematik, Sport…",
    scheduleFrom:"Von",
    scheduleTo:"Bis",
    scheduleRoom:"Raum",
    schedulePlaceholderRoom:"z. B. 204",
    scheduleBuilding:"Gebäude",
    scheduleTeacher:"Lehrer",
    scheduleErrSubject:"Fach ist erforderlich",
    scheduleSave:"Speichern",
    scheduleCancel:"Abbrechen",
    scheduleEdit:"Bearbeiten",
    scheduleDelete:"Löschen",
    scheduleSubjects:["Mathematik","Deutsch","Geschichte","Naturwissenschaften","Englisch","Sport","Kunst","Musik","Technik","Philosophie","Physik-Chemie","Biologie","Spanisch","Französisch","Latein","Informatik","Sonstiges"],
    schoolHolsInfo:"Legen Sie das Sorgerecht Tag für Tag fest.",
    vaultTitle:"Tresor",
    vaultViewFile:"Datei ansehen",

    // ── Slide 3 : popups confirm() jusque-là hardcodées en français ──
    confirmLeaveFamilyFull:"Familie verlassen? Sie verlieren den Zugriff auf Kalender und Nachrichten.",
    confirmLeaveFamilySimple:"Familie verlassen?",
    confirmDeleteNotif:"Diese Benachrichtigung löschen?",
    confirmDeleteAllNotifs:"Alle Benachrichtigungen löschen ({n})?",
    confirmLeaveFamilyDetailed:"Diese Familie verlassen?\n\nSie beginnen mit einer leeren persönlichen Familie neu. Eine Zusammenfassung Ihrer Daten wird für den Export aufbewahrt.",
    confirmRemoveGuest:"{name} aus der Familie entfernen?\n\nDiese Person beginnt mit einer leeren persönlichen Familie neu. Sie behalten die Familie und ihren Code.",
    confirmCreateNewFamily:"Eine separate neue Familie erstellen? Sie können über das Menü oben in der App zwischen Ihren Familien wechseln.",
    confirmRejectRequest:"Diese Anfrage ablehnen?",
    confirmRemoveChild:"{name} aus der Familie entfernen?",
    confirmRemoveObserver:"{name} aus der Familie entfernen?",

    // ── Slide 4 : 14 clés trouvées par audit complet (utilisées dans App.jsx mais jamais définies) ──
    deleteAccount:"Mein Konto löschen",
    deleteAccountDesc:"Diese Aktion ist endgültig. Alle Ihre Daten werden gelöscht.",
    expPaidBy:"Bezahlt von",
    histSub:"Änderungsprotokoll",
    msgAttach:"Datei anhängen",
    msgCaptionPlaceholder:"Beschriftung (optional)…",
    msgLoadingFile:"Wird geladen…",
    msgNotRegistered:"Noch nicht registriert — Einladung erneut senden",
    msgNotRegisteredShort:"nicht registriert",
    multiFamilyInfo:"Sie gehören zu mehreren Familien. Nutzen Sie dieses Menü, um zwischen ihnen zu wechseln.",
    multiFamilyTitle:"Mehrere Familien",
    ...
    clearAll:"Löschen",
    customDateLabel:"Datum {n}",
    eventName:"Name des Ereignisses",
    eventNamePlaceholder:"z. B.: Skiurlaub, Hochzeit...",
    dayLabel:"Tag",
    monthLabel:"Monat",
    yearLabel:"Jahr",
    concernsLabel:"Betrifft",
    childFallback:"Kind {id}",
    custodyAtLabel:"Betreuung bei",
    parentFallback:"Elternteil {id}",
    yearlyRecurrence:"Jährlich wiederholen",

    // ── Slide 7 : texte info dépenses ──
    expPendingInfo:"Jede hinzugefügte Ausgabe ist ⏳ ausstehend, bis sie vom anderen Elternteil bestätigt wird. Sobald sie ✅ akzeptiert wurde, wird sie berücksichtigt. Bei ❌ Ablehnung bleibt sie sichtbar, wird aber von den Summen ausgeschlossen. Jede Aktion wird im Verlauf protokolliert.",

    // ── Slide 9 : placeholders coffre-fort ──
    vaultNamePlaceholder:"z. B.: Gerichtsbeschluss 12.03.2023",
    vaultNotesPlaceholder:"z. B.: Von beiden Parteien unterschrieben...",
    ...
    years:"Jahre",
    joinedFamilyMsg:"ist der Familie beigetreten — Nachrichten aktiviert",
    removedFromFamilyMsg:"wurde aus der Familie entfernt.",
    overridesResetDetail:"Manuelle Tauschtage zurückgesetzt",
    overridesResetMsg:"Alle manuellen Tauschtage wurden zurückgesetzt",
    scheduleConfirmedFor:"Plan von {name} bestätigt",
    expSeriesModified:"Serie geändert, erneute Bestätigung erforderlich",
    expModifiedRevalidate:"geändert — erneute Bestätigung erforderlich",
    occurrenceSingular:"Vorkommen",
    occurrencesPlural:"Vorkommen",
    expSeriesLabel:"Serie",
    expSeriesDeleted:"Serie gelöscht",
    reimConfirmedMsg:"Rückerstattung von {name} ({amount}) bestätigt",
    reimConfirmedTitle:"Rückerstattung bestätigt",
    reimRejectedMsg:"Rückerstattung von {name} ({amount}) abgelehnt",
    reimRejectedTitle:"Rückerstattung abgelehnt",
    modifiedLabel:"Geändert",
    reimModifiedMsg:"Rückerstattung von {name} geändert ({amount}) — erneute Bestätigung erforderlich",
    vaultDocModifiedMsg:"Dokument geändert: „{name}“",
    vaultDocModifiedTitle:"Dokument geändert",
    vaultDocAddedMsg:"Dokument hinzugefügt: „{name}“",
    vaultDocAddedTitle:"Neues Dokument",
    vaultDocDeletedMsg:"Dokument gelöscht: „{name}“",
    vaultDocDeletedTitle:"Dokument gelöscht",
