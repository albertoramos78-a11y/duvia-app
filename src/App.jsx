            ...
            {!inviteResult ? (
              <>
                ...
                <div style={{display:"flex",gap:10}}>
                  ...
                  <button disabled={sendingInvite} onClick={confirmInvite} style={{flex:2,height:44,background:`linear-gradient(135deg,${C.vio},${C.blu})`,color:"#fff",border:"none",borderRadius:12,fontWeight:800,fontSize:13,opacity:sendingInvite?0.6:1,cursor:sendingInvite?"not-allowed":"pointer"}}>
