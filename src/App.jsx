...
function FamilySyncCard() {
  ...
  return (
    <div className="card" style={{marginBottom:16,borderColor:`${C.vio}55`}}>
      <div className="sec" style={{marginBottom:8}}>☁️ {t.familySyncTitle}</div>
      ...
      <div style={{display:"inline-flex",alignItems:"center",gap:6,marginBottom:14,padding:"5px 10px",background:`${SI.color}15`,border:`1px solid ${SI.color}44`,borderRadius:10,fontSize:11,fontWeight:700,color:SI.color}}>
